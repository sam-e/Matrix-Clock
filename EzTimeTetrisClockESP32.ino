 ...
 *******************************************************************/
/*******************************************************************
    Tetris clock updated to include:
      *timed brightness updates
      *adapted for adafruit panel use

    ***DONT FORGET TO ADD WIFI CREDENTIALS***
...
void setup() {
  ...
  display.setMuxDelay(1,1,1,1,1); // Adafruit Panels

  display.setBrightness(255);  // Display Brightness
...
void setMatrixTime() {
  ...
  // Call the function to check time and set panel brightness
  setMatrixBrightness(timeString, AmPmString);
}

void setMatrixBrightness(String timeString, String AmPmString) {
  // Brightness Control
  // Turn down after 9pm
  // Turn up after 6am
  if ( timeString == " 6:00" && AmPmString == "PM") { 
    display.setBrightness(200);
  }
  if ( timeString == " 7:00" && AmPmString == "PM") { 
    display.setBrightness(100);
  }
  if ( timeString == " 8:00" && AmPmString == "PM") { 
    display.setBrightness(50);
  }
  if ( timeString == " 9:00" && AmPmString == "PM") { 
    display.setBrightness(8);
  }
  if ( timeString == " 11:59" && AmPmString == "PM") { 
    display.setBrightness(6);
  }
  if ( timeString == " 6:00" && AmPmString == "AM") { 
